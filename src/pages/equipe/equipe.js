...
class Equipe extends Component {
    ...
    render (){
        return (
            <div className="mainContainer projet">
                <div className="container p-3">
                    <h1 className="bannerTitle">l'equipe</h1>
                    <div className="whiteBg">
                        <p>Lorem ipsum dolor amet woke hella shoreditch, affogato letterpress cred chambray bushwick. Offal kale chips church-key coloring book shaman dreamcatcher tilde, man bun blog mixtape austin tbh cliche. Fixie PBR&B keytar slow-carb intelligentsia etsy tbh gluten-free dreamcatcher. Prism thundercats slow-carb VHS ennui chillwave meggings dreamcatcher.</p>
